...
**Later evaluation addendum:** A fixed 3×3 spatial probe in the [two-timescale follow-up](2026-09-26-two-timescale-assembly-findings.md) decoded doubled-speed direction from this fast field at 12/16, versus 6/16 for the region-averaged probe above. Thus the mean-pooled failure understated spatially decodable motion information. The registered world-state decision still stands: this does not establish autonomous entity binding, and the two-timescale learned state did not improve transfer or forecasting overall.
