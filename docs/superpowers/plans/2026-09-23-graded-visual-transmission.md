...
- [ ] Run one bounded 8/16/32-tick horizon check on the same frozen future-spike target, especially at withheld fast speed. If it fails, reassess objective/temporal representation instead of more parameter sweeps. Seek user approval before production promotion.
