...
- [ ] Test a genuinely local future motion-spike target against persistence and static/blank controls, or a longer horizon, before designing afferent credit. Only after an independent target passes, test next-frame anticipation against frozen and withheld controls. Seek user approval before production promotion.
