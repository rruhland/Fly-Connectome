...
- [ ] Design and test a local afferent-credit rule preserving temporal order and measuring actual next-frame anticipation against frozen, static, and withheld controls. Seek user approval before any production promotion.
