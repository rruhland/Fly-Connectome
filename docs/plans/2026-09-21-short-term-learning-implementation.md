...
- [ ] Train D/F from original crop for200trials on exact seed9060 schedule.
  Save weights/traces/stability/schedule hash. Commit runner before long runs.
- [ ] Frozen initial/trained baseline/D/F15trials each2/3/4/6 seed9081; all-node
...
- [ ] Apply unchanged pass criteria and held3baseline-MSE comparison. Only qualifiers
  get30trials seed9082 and unit-release ablation through warmup/evaluation. No tuning.
- [ ] Review, full tests, findings/metrics/hashes/ledger; commit/push valid state.
...
no review blockers. Initial full suite264passed4skipped; full fix verification pending.
