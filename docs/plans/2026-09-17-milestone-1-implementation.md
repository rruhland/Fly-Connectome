...
### 2026-09-21: bounded adaptation-expression family rejected

User approved concrete adaptation-context proposal. Implemented opt-in A/B forecast gains from existing postsynaptic adaptation, with matching sparse issue-time eligibility. Physical frozen dynamics exact, signs/topology/no-backprop preserved; no new persistent state. Unit-gain real-crop learning reproduces baseline bit-for-bit. Formula evaluated as baseline plus gain corrections to preserve floating-point identity. Full suite243passed4skipped; focused8passed; independent review no blockers.

Both200trial mixed2/4/6 runs completed11158frames89264ticks from identical original weights and saved seed9060 schedule. Concurrent runtime322.18/323.04s; finite/bounded. Frozen15trial/tempo seed9073 evaluation at2/3/4/6: all targets identical, weights frozen,45ON45OFF each. Both candidates fail every tempo. A quiet false alarms2/3/4/6=.94/7.00/6.29/9.44%; OFFanticipation=-.008207/.000190/.001416/.000558. B quiet9.91/10.89/7.45/9.95%; OFF=-.014706/-.000787/.001097/.000510. All0/45correctOFF attempo2; held3baseline/A/B20/21/9of45. Held3MSE baseline.138437,A.139262,B.137843. No qualifiers, no confirmation/training extension. L2targetweight remains nearweakbaseline. This rejects fixedcouplings, not alladaptation use.

Exclusive matched zero-rate learning benchmark37frames medianbaseline/A/B1.0928/1.2080/1.1291s, noisy10.55/3.33%overhead. Persistent directtensors84318bytes all; short4blankframe tensorpeak14917494all, excludesPython/NumPy/RSS andnotfulltrainingpeak. Thirdrepeated PyTorchmemoryexport crashedinCextension; isolatedprocess succeeded. Profiling separated fromtiming/training.

Findings/metrics/weights/update sums/checksums/plot: docs/experiments/2026-09-21-adaptation-context-*. Raw runs/adaptation-context-v1; stagedrunner scripts/adaptation_experiment.py. Commits292802e/1bd7b9f implement boundedexperiment. M1Aunmet,M1Bblocked. New docs/plans/2026-09-21-short-term-synaptic-context-proposal.md specifies depression/facilitation arms with lazyarrivalrecovery and matchinglocalcredit; requiresuserapproval, NOTimplemented. Stopcurrentfamily here.

### 2026-09-21: STP implemented; preflight stops before learning on internal targets

User approved fixed short-term depression/facilitation proposal. Commitcc97645 adds D/F .5utilization/.100s recovery on existing predictive edges, private per-environment compact state/timestamps, lazy arrival updates and cached gains shared by physical E/I currents and local arrival eligibility. Small default environment-aware hook delegates to original impulse. No topology/sign/backprop change; opt-in reference only. Unit-release real-crop learning exact;18focused tests and final261passed4skipped; independent review no blockers/minors.

Preflight5trials each2/3/4/6 seed9080 completed finite/bounded. All-neuron target differences D291/298/439/444 and F181/215/206/394, triggering approvedstop. Directly injected sensory targets and scoredL3body82450 identical throughout. Offline signedfeedforward spike/delay reconstruction matches all downstream observations exactly after initialhistoryboundary; changes are physical, not encodingbug. D/F release on L2->L3 varies: medianD .32769/.24098/.25204/.20712, F1.67240/1.75903/1.75046/1.79298. Notfixedatsaturation; arrivalconditionedpostarrival statistics do not establish timing information. No training orlearningquality verdict.
